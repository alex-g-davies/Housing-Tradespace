...
Beyond the latest median value it derives, per ZIP (spec 002): **YoY % change**,
a **5-year CAGR**, and a quarterly **price-history** series (all from the ZHVI
monthly columns), plus optional **$/sqft** from Redfin.
